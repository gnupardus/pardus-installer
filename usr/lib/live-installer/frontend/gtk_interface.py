...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        self.wizard_pages[self.PAGE_LANGUAGE] = WizardPage(u"Kurulum dilini seçin...", "locales.png")        
        self.wizard_pages[self.PAGE_TIMEZONE] = WizardPage(u"Zaman dilimini seçin...", "time.png")
        self.wizard_pages[self.PAGE_KEYBOARD] = WizardPage(u"Klavyenizin tipini seçin...", "keyboard.png")
        self.wizard_pages[self.PAGE_HDD] = WizardPage(u"Pardus'u hangi diske kuracağınızı seçin...?", "hdd.svg")
        self.wizard_pages[self.PAGE_PARTITIONS] = WizardPage(u"Pardus'u hangi bölüme kuracağınızı seçin...", "hdd.svg")
        self.wizard_pages[self.PAGE_USER] = WizardPage(u"Lütfen isminizi, kullanıcı adınızı, şifre ve makina ismini girin...", "user.png")
        self.wizard_pages[self.PAGE_ADVANCED] = WizardPage(u"Lütfen gelişmiş seçenekleri inceleyin...", "advanced.png")
        self.wizard_pages[self.PAGE_OVERVIEW] = WizardPage(u"Lütfen kurulum özetini dikkatlice inceleyerek hata yapmadığınıza emin olun...", "summary.png")
        self.wizard_pages[self.PAGE_INSTALL] = WizardPage(u"Lütfen Pardus bilgisayarınıza kurulurken bekleyin...", "install.png")
    ...
    def i18n(self):
        ...
        #Installation
        self.wTree.get_widget("label_install_1").set_label(_("Kurulum bittiğinde bilgisayarınızı yeniden başlatmanız gerekecek."))
        self.wTree.get_widget("label_install_2").set_label(_("Kurulum donanımınıza bağlı olarak 15 ila 25 dakika arasında sürecektir."))
        self.wTree.get_widget("label_install_3").set_label(_("Bu sürümü beğeneceğinizi umarız. Pardus' u seçtiğiniz için teşekkürler."))    
